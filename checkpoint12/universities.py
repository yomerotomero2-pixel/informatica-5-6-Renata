...
def main():
     university_fair = {
          ...
          "TEC MILENIO":{"cost":1200,"location":300,"num_majors":9, "official_name": "Universidad Tecmilenio"},
     ...
     api = requests.get("http://universities.hipolabs.com/search?name="+university_fair[uni]["official_name"])
     web_page = api.json()
     for item in web_page:
           print(f"The web page of the university is:",item["domains"])
           plan = university_fair[uni]
           print(plan)
